module github.com/stax-labs/terraform-provider-stax
...
require (
	...
	github.com/stax-labs/stax-golang-sdk v0.0.3
)
...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/cognitoidentity v1.15.11 // indirect
